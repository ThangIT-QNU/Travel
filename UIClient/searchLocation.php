                        ...
                        <div class="blog_navigation">
                            <ul>
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/searchLocation.php?key=<?= $keySearch ?>&page=1">Trang
                                        đầu</a>
                                </li>
                                <?php
                                ...
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/searchLocation.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?>
                                    </a>
                                </li>
                                <?php
                                        }
                                ...
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/searchLocation.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                                        cuối
                                    </a>
                                </li>
                            </ul>
