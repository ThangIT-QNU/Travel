                        ...
                        <div class="blog_navigation">
                            <ul>
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/typeTourDetail.php?page=1">Trang
                                        đầu</a>
                                </li>
                                <?php
                                ...
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/typeTourDetail.php?page=<?= $num ?>"><?= $num ?>
                                    </a>
                                </li>
                                <?php
                                    }
                                ...
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/typeTourDetail.php?page=<?= $allPage ?>">Trang
                                        cuối
                                    </a>
                                </li>
                            </ul>
