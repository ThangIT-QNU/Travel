            ...
            <div class="offers">
                <div class="box offers__box2">
                    <?php
                        ...
                        $allDong = mysqli_query($conn, "SELECT * FROM diadiem,tour WHERE diadiem.idDiaDiem = tour.idDiaDiem AND tenTour LIKE '%$keySearch%' OR tenDiaDiem LIKE '%$keySearch%' ")->num_rows;
                        $allPage = ceil($allDong / $soDongHT);
                        //
                        $sql = "SELECT * FROM diadiem,tour WHERE diadiem.idDiaDiem = tour.idDiaDiem AND tenTour LIKE '%$keySearch%' OR tenDiaDiem LIKE '%$keySearch%' LIMIT $soDongHT OFFSET $pageTT";
                        $query = mysqli_query($conn, $sql);
                    ...
                    <?php } ?>
                    <div style="margin-left:200px; margin-top:100px;" class="blog_navigation">
                        <ul>
                            <li class="blog_dot active">
                                <a class="page-link"
                                    href="http://localhost/Travel/UIClient/searchTour.php?key=<?= $keySearch ?>&page=1">Trang
                                    đầu</a>
                            </li>
                            <?php
                            ...
                            <li class="blog_dot active">
                                <a class="page-link"
                                    href="http://localhost/Travel/UIClient/searchTour.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?>
                                </a>
                            </li>
                            <?php
                                }
                            ...
                            <li class="blog_dot active">
                                <a class="page-link"
                                    href="http://localhost/Travel/UIClient/searchTour.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                                    cuối
                                </a>
                            </li>
                        </ul>
