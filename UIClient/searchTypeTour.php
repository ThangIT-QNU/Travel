        ...
        <div class="main">
            ...
            <div class="main__slide">
                <div class="home_slide__item">
                    <div class="home_slide__background" style="background-image: url(../styles/images/15.jpg)"></div>
                        ...
                        <div style="margin-top:40px;" id="tabs-2" class="tabs_content animated fadeIn">
                            <form action="" method="get" class="search_content">
                                <div class="search_content__item">
                                    ...
                                    <input type="text" name="keySearch"
                                        ...
                                        placeholder="Nhập vào tên loại tour mà bạn muốn tìm kiếm">
                                </div>
                            ...
                            <?php
                                if (isset($_GET['btnSearch'])) {
                                    ...
                                    header("Location:http://localhost/Travel/UIClient/searchTypeTour.php?key=$keySearch");
                                }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="blog__list">
                        ...
                        <div class="blog_post">
                            <div class="blog_post_image">
                                <img class="zoom_img" src="../styles/images/<?= $row['hinhAnhLoaiTour']?>" alt="">
                            </div>
                            <div class="blog_post_meta">
                            </div>
                            <div class="blog_post_title"><a href="#"><?= $row['tenLoaiTour']?></a></div>
                            <div class="blog_post_text">
                                <p><?= $row['thongTinLoaiTour']?></p>
                            </div>
                        </div>
                        <?php }  ?>
                        <div class="blog_navigation">
                            <ul>
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/searchTypeTour.php?key=<?= $keySearch ?>&page=1">Trang
                                        đầu</a>
                                </li>
                                <?php
                                ...
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/searchTypeTour.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?>
                                    </a>
                                </li>
                                <?php
                                    }
                                ...
                                <li class="blog_dot active">
                                    <a class="page-link"
                                        href="http://localhost/Travel/UIClient/searchTypeTour.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                                        cuối
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="box footer__box">
                <div class="footer__about">
                    <div class="footer__logo">
                        <div class="logo">
                            <a href="#"><img src="../styles/images/logo.png" alt="">VietTravel</a>
                        </div>
                    </div>
