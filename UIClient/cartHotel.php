<?php ob_start(); 
    ...
    if (isset($_GET['idKhachSan'])) {
      ...
      unset($_SESSION['cartHotel'][$idKhachSan]);
      header('Location:http://localhost/Travel/UIClient/cartHotel.php');
    }
...
<body style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div class="main">
            <div class="main__slide">
                <div class="home_slide__item">
                    <div class="home_slide__background" style="background-image: url(../styles/images/KS21.jpg)"></div>
                    <div class="home_slider__content">
                        <div class="home_slider_content_inner animated bounceInLeft">
                            <h1></h1>
                            <h1>Book Khách Sạn</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div style=" margin: 0px 50px 30px 50px;">
        ...
        <div class="col-md-12">
                ...
                <center>
                    ...
                    <tbody>
                        <?php
                            ...
                            {
                                $total += $value['countHotel'];
                                $price = $value['countHotel'] * $value['costHotel'];
                                $sum = $sum += $price;
                        ?>
                        <tr style="font-size:21px;">
                            <td><img style="height:50px; width:50px" src="../styles/images/<?= $value['imgHotel'] ?>">
                            </td>
                            <td><?php echo $value['nameHotel'] ?></td>
                            <td>
                                <?php
                                        $date = date('d-m-Y',strtotime($value['dateStart']));
                                        echo $date;
                                    ?>
                            </td>
                            <td>
                                <?php
                                        $date = date('d-m-Y',strtotime($value['dateEnd']));
                                        echo $date;
                                    ?>
                            </td>
                            <td><?php echo number_format($value['costHotel']) ?> VNĐ</td>
                            <td><?php echo $value['countHotel'] ?></td>
                            <td><?php echo number_format($price) ?> VNĐ</td>
                            <td><a style="color:red" href="cartHotel.php?idKhachSan=<?php echo $key ?>"><i
                                        class="fas fa-trash-alt"></i></a></td>
                        </tr>
                        <?php }
                            $_SESSION['numberHotel'] = $total;
                        } ?>
                    </tbody>
                    <div class="cart-top ">
                        <h4> <b style="font-size:25px;">Tổng Tiền:</b>
                            ...
                            <a style="font-size:20px; float:right;" class="btn btn-danger"
                                href="cartHotel.php?delete=1">Xóa
                                Tất Cả</a>
                        </h4><br>
                    </div>
                </center>
            ...
            <h1><b>Tổng số lượng khách sạn:</b> <span
                    class="badge badge-secondary badge-pill"><?php echo $total ?></span>
            </h1>
            <br>
            <?php }
                } ?>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                <div class="row p-t-20">
                    <div style="font-size:25px;" class="col-md-12">
                        <div>
                            <b> Điền thông tin để book - Lưu ý: những trường có dấu <span class="text-danger">(*)
                                </span> đều bắt buộc phải
                                nhập!!!</b>
                            <br><br>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a style="font-size:21px;" class="btn btn-info float-left"
                            href="http://localhost/Travel/UIClient/tour.php">Tiếp Tục Book Khách Sạn</a>
                    </div>
                    <div class="col-md-6">
        ...
        ?>
            <div class="pt-5" style="margin-top:50px; color:red; height: 300px;">
                <center>
                    ...
                    <b style="font-size:25px;">Vui lòng thêm khách sạn vào giỏ hàng.</b>
                </center>
            </div>
            <?php
        }
    ...
    if(isset($_POST['btnOder'])){
        ...
        foreach($_SESSION['cartHotel'] as $key => $value)
        {
            ...
            if ($queryOder){
                ...
                echo    "<script> 
                            alert('Thanh toán không thành công!');location.href = 'http://localhost/Travel/UIClient/cartHotel.php';
                        </script>";
