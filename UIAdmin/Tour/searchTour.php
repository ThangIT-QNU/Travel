        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                        ...
                        <div class="col-md-7">
                            <form class="col-md-7 form-inline" style="margin-top:42px; float:right">
                                <input class="form-control mr-sm-2" style="width: 290px;" type="search" name="keySearch"
                                    placeholder="Nhập tên tour để tìm kiếm" aria-label="Search">
                            ...
                            if (isset($_GET['btnSearch'])) {
                                ...
                                header("Location:http://localhost/Travel/UIAdmin/Tour/searchTour.php?key=$keySearch");
                            }
                        ?>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered text-center">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-center">LOẠI TOUR</th>
                                ...
                                <?php
                                    ...
                                    $allDong = mysqli_query($conn, "SELECT * FROM tour WHERE tenTour LIKE '%$keySearch%'")->num_rows;
                                    $allPage = ceil($allDong / $soDongHT);
                                    //
                                    $sql = "SELECT * FROM tour WHERE tenTour LIKE '%$keySearch%' LIMIT $soDongHT OFFSET $pageTT";
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><?= $row['idTour'] ?></td>
                                <td class="text-center"><?= $row['tenTour'] ?></td>
                                <td class="text-center">
                                    <?php echo substr($row['thongTinTour'], 0, 51)?></td>
                                <td class="text-center">
                                    <img class="rounded" style="width: 100px; height: 78px;"
                                        src="http://localhost/Travel/styles/images/<?= $row['hinhAnhTour'] ?>">
                                </td>
                                <td class="text-center">
                                    <?php
                                ...
                                <td class="text-center"><?= $row['noiKhoiHanhTour'] ?></td>
                                <td class="text-center"><?= $row['soLuongNguoi'] ?></td>
                                <td class="text-center"><?= number_format($row['giaTour']) ?></td>
                                <td class="align-middle">
                                    <?php
                                if ($row['idLoaiTour'] == 1)
                                    echo "Du Lịch Mice";
                                    else if ($row['idLoaiTour'] == 2)
                                        echo "Du lịch ẩm thực";
                                    else if ($row['idLoaiTour'] == 3)
                                        echo "Du lịch lữ hành";
                                    else if ($row['idLoaiTour'] == 4)
                                        echo "Du lịch tham quan";
                                    else if ($row['idLoaiTour'] == 5)
                                        echo "Du lịch văn hóa";
                                else
                                    echo " Du lịch xanh";
                                ?>
                                </td>
                                ...
                                if ($row['idLoaiTour'] == 1)
                                    echo "Tp. Hồ Chí Minh";
                                        ...
                                        echo "Đà Lạt";
                                    else if ($row['idLoaiTour'] == 6)
                                        echo "Nha Trang";
                                    else if ($row['idLoaiTour'] == 7)
                                        echo "Phú Yên";
                                    else if ($row['idLoaiTour'] == 8)
                                        echo "Hội An";
                                    else if ($row['idLoaiTour'] == 9)
                                        echo "Bà Nà Hill";
                                    else if ($row['idLoaiTour'] == 10)
                                        echo "Phú Quốc";
                                    else if ($row['idLoaiTour'] == 11)
                                        echo "SaPa";
                                else
                                    echo "Hà Giang";
                                ?>
                                ...
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Tour/updateTour.php?idTour=<?= $row['idTour'] ?>"
                                        class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>&nbsp;UPDATE</a>
                                </td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Tour/deleteTour.php?idTour=<?= $row['idTour'] ?>"
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Tour/searchTour.php?key=<?= $keySearch ?>&page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Tour/searchTour.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                            }
                        } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Tour/searchTour.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
