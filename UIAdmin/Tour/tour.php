        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                        ...
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <?php
                                    ...
                                    $allDong = mysqli_query($conn, "SELECT * FROM tour")->num_rows;
                                    $allPage = ceil($allDong / $soDongHT);
                                    $sql = "SELECT * FROM tour,loaitour,diadiem WHERE tour.idLoaiTour = loaitour.idLoaiTour AND tour.idDiaDiem = diadiem.idDiaDiem LIMIT $soDongHT OFFSET $pageTT";
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php echo substr($row['thongTinTour'], 0, 50)?></td>
                                <td class="text-center">
                                    <img class="rounded" style="width: 100px; height: 70px;"
                                ...
                                <td class="text-center"><?= number_format($row['giaTour'])?> VND</td>
                                <td class="align-middle">
                                    <?= $row['tenLoaiTour'] ?>
                                </td>
                                <td class="align-middle"><?php echo $row['tenDiaDiem'] ?></td>
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link" href="http://localhost/Travel/UIAdmin/Tour/tour.php?page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Tour/tour.php?page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                            }
                        } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Tour/tour.php?page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
