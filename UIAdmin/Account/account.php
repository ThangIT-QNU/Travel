        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link" href="http://localhost/Travel/UIAdmin/Account/account.php?page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Account/account.php?page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                            }
                        } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Account/account.php?page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
