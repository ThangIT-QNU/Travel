        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                    ...
                    <table class="table table-bordered text-center">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-center">Ngày đăng nhập</th>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><?= $row['idTaiKhoan'] ?></td>
                                ...
                                <td class="text-center"><?= $row['OTP'] ?></td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Account/updateAccount.php?taiKhoan=<?= $row['idTaiKhoan'] ?>"
                                        class="btn btn-warning btn-sm"><i class="fas fa-edit"></i>&nbsp;UPDATE</a>
                                </td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Account/deleteAccount.php?taiKhoan=<?= $row['idTaiKhoan'] ?>"
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Account/searchAccount.php?key=<?= $keySearch ?>&page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Account/searchAccount.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                        }
                    } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Account/searchAccount.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
