...
<body style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-lg-5">
                            <h1 class="page-header" style="color:blue;"><b>Cập nhật thông tin khách sạn</b>
                            </h1>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM diadiem,khachsan  WHERE diadiem.idDiaDiem = khachsan.idDiaDiem AND idKhachSan='$idKhachSan' ";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?= $row['tenKhachSan']; ?>"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $row['tenDiaDiem']?>" disabled
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label">Giá Phòng:<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" value="<?php echo $row['giaPhongKS']?>"
                                                        name="txtPrice" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label">Số Người:<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" value="<?php echo $row['soLuongNguoi']?>"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="imgHotel"
                                                        value="<?php echo $row['hinhAnhKS']?>" class=" form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <img src="../../styles/images/<?= $row['hinhAnhKS']?>" width="150"
                                                        height="70">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Thông tin :<span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="txtInformation" required class="form-control"><?= $row['noiDungKS']?>
                                                    </textarea>
                                                    <script>
    ...
    <?php
        if (isset($_POST['btnUpdate'])) {
            ...
            //
            if($imgHotel!= ""){
                $sqlUpdate = "UPDATE khachsan SET tenKhachSan='$txtNameHotel',giaPhongKS='$txtPrice', soLuongNguoi='$txtNumber', 
                                    hinhAnhKS='$imgHotel', banDo='$txtMap', noiDungKS='$txtInformation' WHERE idKhachSan='$idKhachSan'";
                $query = mysqli_query($conn, $sqlUpdate);
                if ($query){
                    $path = '../../styles/images/' . $_FILES['txtHinhAnhKhachSan']['name'];
                    $diaChiIMG = $_FILES['imgHotel']['tmp_name'];
                    move_uploaded_file($diaChiIMG, $path);
                    echo    "<script> 
                                alert('Bạn đã cập nhật thông tin khách sạn thành công!');
                ...
                $sql = "UPDATE khachsan SET tenKhachSan='$txtNameHotel',giaPhongKS='$txtPrice', soLuongNguoi='$txtNumber',
                                             banDo='$txtMap', noiDungKS='$txtInformation' WHERE idKhachSan='$idKhachSan'";
                $query = mysqli_query($conn, $sql);
                    if($query){
                        echo    "<script> 
                                    alert('Bạn đã cập nhật thông tin khách sạn thành công!');
