        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-lg-5">
                            <h1 class="page-header" style="color:blue;"><b>Khách Sạn</b>
                                <a style="width: 110px;" href="http://localhost/Travel/UIAdmin/Hotel/addHotel.php"
                        ...
                        <div class="col-md-7">
                            ...
                            if (isset($_GET['btnSearch'])) {
                                ...
                                header("Location:http://localhost/Travel/UIAdmin/Hotel/searchHotel.php?key=$keySearch");
                            }
                        ?>
                        </div>
                    </div>
                        ...
                        <thead>
                            ...
                            <tr class="bg-primary">
                                ...
                                <?php
                                    ...
                                    $allDong = mysqli_query($conn, "SELECT * FROM khachsan WHERE tenKhachSan LIKE '%$keySearch%'")->num_rows;
                                    $allPage = ceil($allDong / $soDongHT);
                                    //
                                    $sql = "SELECT * FROM diadiem,khachsan WHERE diadiem.idDiaDiem = khachSan.idDiaDiem AND tenKhachSan LIKE '%$keySearch%' LIMIT $soDongHT OFFSET $pageTT";
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img class="rounded" style="width: 100px; height: 80px;"
                                        src="http://localhost/Travel/styles/images/<?= $row['hinhAnhKS'] ?>">
                                </td>
                                <td class="text-center">
                                    <?php echo substr($row['noiDungKS'], 0, 100)?>
                                </td>
                                <td class="text-center"><?= $row['soLuongNguoi'] ?></td>
                                <td class="text-center"><?= $row['ngayNhanPhong'] ?></td>
                                <td class="text-center"><?= $row['ngayTraPhong'] ?></td>
                                <td class="text-center"><?= number_format($row['giaPhongKS']) ?></td>
                                <td class="align-middle"><?= $row['tenDiaDiem']?></td>
                                <td class="text-center"><iframe src="<?= $row['banDo'] ?>" width="150px" height="70px"
                                        style="border:0;" frameborder="0"></iframe>
                                </td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Hotel/updateHotel.php?idKhachSan=<?= $row['idKhachSan'] ?>"
                                        class="btn btn-warning btn-sm"><i class="fas fa-edit"></i>&nbsp;UPDATE</a>
                                </td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Hotel/deleteHotel.php?idKhachSan=<?= $row['idKhachSan'] ?>"
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Hotel/searchHotel.php?key=<?= $keySearch ?>&page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Hotel/searchHotel.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                            }
                        } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Hotel/searchHotel.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
