        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="col-lg-5">
                            <h1 class="page-header" style="color:blue;"><b>Location</b>
                                <a style="width: 110px;" href="http://localhost/Travel/UIAdmin/Location/addLocation.php"
                        ...
                        <div class="col-md-7">
                            <form class="col-md-7 form-inline" style="margin-top:42px; float:right">
                                <input class="form-control mr-sm-2" style="width: 290px;" type="search" name="keySearch"
                                    placeholder="Nhập tên địa để tìm kiếm" aria-label="Search">
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link" href="http://localhost/Travel/UIAdmin/Location/location.php?page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Location/location.php?page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                        }
                    } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Location/location.php?page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
                <!-- /.container-fluid -->
            </div>
