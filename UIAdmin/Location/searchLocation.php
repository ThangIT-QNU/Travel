        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-lg-5">
                            <h1 class="page-header" style="color:blue;"><b>Location</b>
                        ...
                        <div class="col-md-7">
                            <form class="col-md-7 form-inline" style="margin-top:42px; float:right">
                                <input class="form-control mr-sm-2" style="width: 290px;" type="search" name="keySearch"
                                    placeholder="Nhập tên địa điểm để tìm kiếm" aria-label="Search">
                            ...
                            if (isset($_GET['btnSearch'])) {
                                ...
                                header("Location:http://localhost/Travel/UIAdmin/Location/searchLocation.php?key=$keySearch");
                            }
                        ?>
                        </div>
                    </div>
                ...
                <div style="height:350px" class="col-md-12">
                    <table class="table table-bordered text-center">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <?php
                                    ...
                                    $allDong = mysqli_query($conn, "SELECT * FROM diadiem WHERE tenDiaDiem LIKE '%$keySearch%'")->num_rows;
                                    $allPage = ceil($allDong / $soDongHT);
                                    //
                                    $sql = "SELECT * FROM diadiem WHERE tenDiaDiem LIKE '%$keySearch%' LIMIT $soDongHT OFFSET $pageTT";
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><?= $row['idDiaDiem'] ?></td>
                                <td class="text-center"><?= $row['tenDiaDiem'] ?></td>
                                <td class="text-center">
                                    <img class="rounded" style="width: 100px; height: 80px;"
                                        src="http://localhost/Travel/styles/images/<?= $row['hinhAnh'] ?>">
                                </td>
                                <td class="text-center">
                                    <?php echo substr($row['noiDung'], 0, 351)?>
                                </td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Location/updateLocation.php?idDiaDiem=<?= $row['idDiaDiem'] ?>"
                                        class="btn btn-warning btn-sm"><i class="fas fa-edit"></i>&nbsp;UPDATE</a>
                                </td>
                                <td style="width: 150px;">
                                    <a href="http://localhost/Travel/UIAdmin/Location/deleteLocation.php?idDiaDiem=<?= $row['idDiaDiem'] ?>"
                ...
                <ul style="margin-left:460px;" class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Location/searchLocation.php?key=<?= $keySearch ?>&page=1">Trang
                            đầu</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Location/searchLocation.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?></a>
                    </li>
                    <?php
                        }
                    } else {
                    ...
                    <li class="page-item"><a class="page-link"
                            href="http://localhost/Travel/UIAdmin/Location/searchLocation.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                            cuối</a></li>
                </ul>
                <!-- /.container-fluid -->
            </div>
