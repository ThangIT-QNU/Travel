        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-lg-5">
                            <h1 class="page-header" style="color:blue;"><b>Update Type Tour</b>
                            </h1>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM loaitour WHERE idLoaiTour='$idLoaiTour' ";
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" value="<?php echo $row['hinhAnhLoaiTour']?>"
                                                        name="imgTypeTour" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <img src="../../styles/images/<?= $row['hinhAnhLoaiTour']?>"
                                                        width="150" height="70">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" type="text" name="txtIntroduce"
                                                        class="form-control"><?php echo $row['thongTinLoaiTour'] ?></textarea>
                                                    <script>
                ...
                <?php
                        ...
                        if (isset($_POST['btnUpdate'])) {
                            ...
                            //
                            if ($imgTypeTour != "") {
                                $sqlUpdate = "UPDATE loaitour SET tenLoaiTour='$txtNameType',hinhAnhLoaiTour='$imgTypeTour', 
                                                                thongTinLoaiTour='$txtIntroduce'WHERE idLoaiTour='$idLoaiTour'";
                                ...
                                if ($query){
                                    ...
                                    echo    "<script>alert('Chúc mừng bạn đã Update TypeTour thành công!');
                                                location.href = 'http://localhost/Travel/UIAdmin/TypeTour/typeTour.php';
                                            </script>";
                                }
                                else
                                    echo "<script>alert('Update TypeTour thất bại,vui lòng kiểm tra lại!');</script>";
                            }else {
                                $sql = "UPDATE loaitour SET tenLoaiTour='$txtNameType',hinhAnhLoaiTour='$imgTypeTour', 
                                                                thongTinLoaiTour='$txtIntroduce'WHERE idLoaiTour='$idLoaiTour'";
                                $query = mysqli_query($conn, $sql);
                                if ($query){
                                echo    "<script>alert('Chúc mừng bạn đã update TypeTour thành công!');
